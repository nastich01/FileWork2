...
public class MainActivity2 extends AlertDialog.Builder {

    private String currentPath = Environment.getExternalStorageDirectory().getPath();
    //private String currentPath = Context.getExternalFilesDir(null).getPath();
    ...
    public AlertDialog show() {
        ...
        System.out.println(getFiles(currentPath));
        listView.setAdapter(new FileAdapter(getContext(), files));
        return super.show();
    }

    public MainActivity2 setFilter(final String filter) {
    ...
    public MainActivity2 setOnlyFoldersFilter() {
    ...
    public MainActivity2 setOpenDialogListener(OpenDialogListener listener) {
        this.listener = listener;
        return this;
    }

    public MainActivity2 setFolderIcon(Drawable drawable) {
        this.folderIcon = drawable;
        return this;
    }

    public MainActivity2 setFileIcon(Drawable drawable) {
        this.fileIcon = drawable;
        return this;
    }

    public MainActivity2 setAccessDeniedMessage(String message) {
